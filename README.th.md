...
- การแปลแบบดื่มด่ำทำงานผ่านบริการ LLM ในตัวของ DSH (โมเดลที่คุณตั้งค่าไว้) ไม่ใช่ API ของบุคคลที่สาม โดยจะทำงานเฉพาะกับข้อความภาษาอังกฤษยาว ๆ เมื่อมีการใช้โลแคลที่ไม่ใช่ภาษาจีนเท่านั้น และภาษาค่าเริ่มต้นจะไม่ถูกส่งไปแปล
