...
- تعمل الترجمة الغامرة عبر خدمة LLM المدمجة في DSH (نموذجك المُعدّ)، وليس عبر API طرف ثالث. وهي لا تعمل إلا مع النصوص الإنجليزية الطويلة عندما تكون لغة غير صينية نشطة؛ ولا تُرسَل اللغة الافتراضية للترجمة أبدًا.
