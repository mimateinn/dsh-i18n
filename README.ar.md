...
لا تملك الإضافة أي تبعيات وقت التشغيل، ولا اتصالات شبكة، ولا تجميع بيانات (telemetry)، ولا وصول إلى نظام الملفات. إنها تخزّن فقط معرّف الـ locale المختار في localStorage الخاص بالمتصفح.
