...
Eklentinin çalışma zamanı bağımlılığı, ağ çağrısı, telemetrisi veya dosya sistemi erişimi yoktur. Yalnızca seçilen yerel ayar kimliğini tarayıcı localStorage'ında saklar.
