...
Plugin không có dependency runtime, lời gọi mạng, telemetry hay quyền truy cập filesystem. Nó chỉ lưu id locale đã chọn trong localStorage của trình duyệt.
