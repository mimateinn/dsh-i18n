...
O plugin não tem dependências de tempo de execução, chamadas de rede, telemetria ou acesso ao sistema de arquivos. Ele armazena apenas o id de locale selecionado no localStorage do navegador.
