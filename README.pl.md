...
Wtyczka nie ma zależności środowiska uruchomieniowego, wywołań sieciowych, telemetrii ani dostępu do systemu plików. Przechowuje wyłącznie identyfikator wybranego języka w przeglądarkowym localStorage.
