...
- Die automatische Übersetzung läuft über DSHs eingebauten LLM-Dienst (dein konfiguriertes Modell), nicht über eine Drittanbieter-API. Sie wird nur für lange englische Prosa ausgelöst, wenn eine nicht-chinesische Locale aktiv ist; die Standardsprache wird niemals zur Übersetzung gesendet.
