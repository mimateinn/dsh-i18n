...
- Імерсивний переклад виконується через вбудований LLM-сервіс DSH (вашу налаштовану модель), а не через сторонній API. Він спрацьовує лише для довгого англійського тексту, коли активна некитайська локаль; мова за замовчуванням ніколи не надсилається на переклад.
