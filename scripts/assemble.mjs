...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const DOM_SKIP_SELECTOR = "input, textarea, select, [contenteditable], pre, code, script, style, [data-conversation-scroll], [data-composer-input], [data-composer-card], [data-composer-seat], [data-team-id], [data-agent-teams-panel-open], [data-agent-teams-collapsed]";
    ...
    function domShouldSkip(node) {
      return closestMatches(node, DOM_SKIP_SELECTOR);
    }
